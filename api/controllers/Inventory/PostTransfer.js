...
exports.postData = async (req, res) => {
  try {
    ...
    let REQ = await SeqFunc.getOne( req.dbconn.INV_TransferHeader,{ where: { TransNo: TransNo } } );
    ...
    if (REQ.success) {
      ...
      if (REQ.Data.TransType === 'XFR'){
        ...
        if (Consumption.Success){
          await Stock.Addition.Addition(req.dbconn,req.dbconn.INV_TransferDetail, TransNo, REQ.Data.DestinationLocationCode, REQ.Data.DestinationLocation, REQ.Data.TransType,0,0, res)
        }
      }
